...
Br:
    ...
    Function TestSalesAndReturn() As Boolean
        Return (Flag = FlagState.مبيعات_الصالة OrElse Flag = FlagState.مردودات_مبيعات_الصالة OrElse Flag = FlagState.المبيعات OrElse Flag = FlagState.مردودات_المبيعات OrElse Flag = FlagState.المبيعات_الضريبية OrElse Flag = FlagState.مردودات_المبيعات_الضريبية OrElse Flag = FlagState.مبيعات_الوردية)
    End Function

    Function TestSalesAndOnly() As Boolean
        'Return (Flag = FlagState.مبيعات_الصالة OrElse Flag = FlagState.المبيعات OrElse Flag = FlagState.المبيعات_الضريبية)
        Return (Flag = FlagState.مبيعات_الصالة OrElse Flag = FlagState.المبيعات_الضريبية OrElse Flag = FlagState.مبيعات_لموردين OrElse Flag = FlagState.مبيعات_الوردية OrElse Flag = FlagState.المبيعات)
    End Function
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Flag = FlagState.المبيعات AndAlso Md.IsCustTel = 1 AndAlso Mobile.Text.Trim = "" Then
