...
Public Class Pumps
    ...
    Public TableName As String = "Pumps"
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.FillCombo("Tanks", CboMain, "")

        Dim v() As String = {SubId, SubName, "TankId", "Bal0"}
        bm.Fields = v
        Dim c() As Control = {txtID, txtName, CboMain, Bal0}
        bm.control = c
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, Bal0.KeyDown
    ...
    Private Sub LoadResource()
        ...
        lblName2.SetResourceReference(Label.ContentProperty, "Tank")
