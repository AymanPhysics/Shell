...
Public Class Groups
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "TradingFirstAccNo", "TradingLastAccNo", "BudgetAccNo", "CashCustPrevent", "IsShop"}
        bm.control = New Control() {txtID, txtName, TradingFirstAccNo, TradingLastAccNo, BudgetAccNo, CashCustPrevent, CheckBox1}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Val(TradingFirstAccNo.Text) = 0 Then
            bm.ShowMSG("Please, Select Main AccNo")
            TradingFirstAccNo.Focus()
            Return
        End If
        If Val(TradingLastAccNo.Text) = 0 Then
            bm.ShowMSG("Please, Select Main AccNo")
            TradingLastAccNo.Focus()
            Return
        End If
        If Val(BudgetAccNo.Text) = 0 Then
            bm.ShowMSG("Please, Select Main AccNo")
            BudgetAccNo.Focus()
            Return
        End If
