...
Public Class Suppliers
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        bm.Fields = New String() {SubId, SubName, "AccNo", "CountryId", "CityId", "AreaId", "Address", "HeadMaster", "Tel1", "Tel2", "Tel3", "Fax", "Bal0", "CommercialRegister", "TaxCard"}
        bm.control = New Control() {txtID, txtName, AccNo, CountryId, CityId, AreaId, Address, HeadMaster, Tel1, Tel2, Tel3, Fax, Bal0, CommercialRegister, TaxCard}
    ...
    Private Sub txtID_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyUp
        If bm.ShowHelp(CType(Parent, Page).Title, txtID, txtName, e, "select cast(Id as varchar(100)) Id,Name from " & TableName) Then
            txtName.Focus()
        End If
    End Sub
