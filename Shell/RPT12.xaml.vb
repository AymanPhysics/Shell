...
Public Class RPT12
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@ToDate", "@GroupId", "GroupName", "@TypeId", "TypeName", "@StoreId", "@ItemId", "@ColorId", "ColorName", "@SizeId", "SizeName", "Header", "P", "Z", "N"}

        rpt.paravalue = New String() {ToDate.SelectedDate, Val(GroupId.Text), GroupName.Text, Val(TypeId.Text), TypeName.Text, Val(StoreId.Text), Val(ItemId.Text), Val(ColorId.Text), ColorName.Text, Val(SizeId.Text), SizeName.Text, CType(Parent, Page).Title, IIf(P.IsChecked, 1, 0), IIf(Z.IsChecked, 1, 0), IIf(N.IsChecked, 1, 0)}
        Select Case Flag
            Case 1
            ...
            Case 8
                rpt.Rpt = "StoreBalSalesPrice.rpt"
            Case 9
                rpt.Rpt = "StoreBalAllSalesPrice.rpt"
        End Select
        rpt.Show()
    End Sub
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles StoreId.KeyDown, ItemId.KeyDown, ColorId.KeyDown, SizeId.KeyDown, GroupId.KeyDown, TypeId.KeyDown
