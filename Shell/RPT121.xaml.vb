...
Public Class RPT121
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@Shift", "@FromInvoiceNo", "@ToInvoiceNo", "@FromDate", "@ToDate", "@GroupId", "GroupName", "@TypeId", "TypeName", "@StoreId", "@ItemId", "@ColorId", "ColorName", "@SizeId", "SizeName", "Header", "P", "Z", "N"}

        rpt.paravalue = New String() {0, 0, 0, FromDate.SelectedDate, ToDate.SelectedDate, Val(GroupId.Text), GroupName.Text, Val(TypeId.Text), TypeName.Text, Val(StoreId.Text), Val(ItemId.Text), Val(ColorId.Text), ColorName.Text, Val(SizeId.Text), SizeName.Text, CType(Parent, Page).Title, IIf(P.IsChecked, 1, 0), IIf(Z.IsChecked, 1, 0), IIf(N.IsChecked, 1, 0)}
        Select Case Flag
            Case 1
                rpt.Rpt = "ItemMovement.rpt"
            Case 2
                rpt.Rpt = "Inventory.rpt"
        End Select
        rpt.Show()
    End Sub
