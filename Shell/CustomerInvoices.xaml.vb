...
Public Class CustomerInvoices
    ...
    Private Sub LoadResource()
        ...
        lblCountryId1.SetResourceReference(Label.ContentProperty, "CountryId")
        lblCityId1.SetResourceReference(Label.ContentProperty, "CityId")
        lblAreaId1.SetResourceReference(Label.ContentProperty, "AreaId")
